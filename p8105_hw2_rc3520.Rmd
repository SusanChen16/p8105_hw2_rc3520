...
mr_trash_wheel includes 584 observations and 9 variables.
professor_trash_wheel includes 106 observations and 14 variables.
The total weight of trash collected by Professor Trash Wheel is `r professor_trash_wheel %>%
  select(weight_tons) %>%
  colSums()` tons.
gwynnda includes 155 observations and 13 variables.
